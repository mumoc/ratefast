...
describe Item do
  ...
  describe 'fixed' do
    it "return a item with field fixed is equal to true" do
      ...
      expect(Item.fixed(item.voting_id).first).to eq(item)
    end
  end
